							...
							<div class="panel panel-default">
								<div class="panel-heading">
								  ...
								  <div class="panel-body">
									<form action="/updatePenawaran/<?php echo e($edit->idPenawaran); ?>" method="POST" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
 
										<div class="form-group">  
										<label class="col-sm-3 control-label">Tanggal Penawaran</label>
											<div class="col-sm-6">
											<input type="date" placeholder="Placeholder text" class="form-control" name="tanggalPenawaran" value="<?php echo e($edit->tanggalPenawaran); ?>" readonly="readonly" required> 
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" readonly="readonly" class="form-control" name="jenisIkan" value="<?php echo e($edit->jenisIkan); ?>" required>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Jumlah Ikan(kg)</label>
											<div class="col-sm-6">
												<input type="text" placeholder="kg" readonly="readonly" class="form-control" name="jumlahIkan" value="<?php echo e($edit->jumlahIkan); ?>" required>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Harga Ikan (Rp)</label>
											<div class="col-sm-6">
												<input type="text" placeholder="Rp" class="form-control" readonly="readonly" name="hargaIkan" value="<?php echo e($edit->hargaIkan); ?>" required>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Status Penawaran</label>
											<div class="col-sm-6">
												<select name="status" class="form-control" value="<?php echo e($edit->statusPenawaran); ?>" >
