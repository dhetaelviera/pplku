								...
								<div class="panel-heading">
									...
									<tr>
										...
										<tr>
											...
											<a href="/terimaTransaksi/<?php echo e($data->idTransaksi); ?>"><button type="submit" class="btn btn-success"> <font color="white">Terima</font></button></a>
											<a href="/tolakTransaksi/<?php echo e($data->idTransaksi); ?>"><button type="submit" class="btn btn-danger"> <font color="white">Tolak</font></button></a>
											</td>
										</tr>
