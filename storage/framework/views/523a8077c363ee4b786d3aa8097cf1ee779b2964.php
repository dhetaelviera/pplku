              ...
              <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="<?php echo e(url('/login')); ?>">Masuk</a></li>
                    ...
                    <div class="wrapper">
                      ...
                      <div class="col-md-6">
                        <div class="about-photo">
                          <img src="assets/images/LOGO 1.png" alt="About Image" />
                        </div>
                      </div>

                      <div class="col-md-6">
                        <div class="heading about-content"> 
                          <p>Merupakan sebuah platform untuk para agen penyedia ikan dan pengusaha ikan. Mempermudah dalam proses pencarian ikan dan transaksi.</p>
                          <p>Mari bergabung dan dapatkan keuntungannya.</p>
                          <div class="signature">
                            <h4> by PPL-C Tim 10</h4>
