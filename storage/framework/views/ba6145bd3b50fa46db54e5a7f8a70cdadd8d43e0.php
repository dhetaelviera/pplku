							...
							<div class="panel panel-default">
								<div class="panel-heading">
								  ...
								  <div class="panel-body">
									<form action="/beliPenawaran/<?php echo e($beli->id); ?>" method="POST" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" name="opsiIkan" value="<?php echo e($beli->opsiIkan); ?>" readonly="readonly" required>
											</div>
										</div>
										<div class="form-group">
