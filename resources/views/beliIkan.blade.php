				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="/updateBeli/{{$beli->idPenawaran}}" method="POST" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
								{{ csrf_field() }}

									<div class="form-group">  
										<label class="col-sm-3 control-label">ID Penawaran</label>
										<div class="col-sm-6">
											<input type="text" placeholder="Placeholder text" readonly="readonly" class="form-control" name="id" value="{{$beli->idPenawaran}}" required> 
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="opsiIkan" value="{{$beli->tes->opsi}}" readonly="readonly" required>
										</div>
									</div>
									<div class="form-group">
